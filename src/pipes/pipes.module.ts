...
@NgModule({
  declarations: [IsCurrentUserPipe, BuildUrlPipe, ColorFirstLetterPipe, NumberFormatBrPipe],
  imports: [],
  exports: [IsCurrentUserPipe, BuildUrlPipe, ColorFirstLetterPipe, NumberFormatBrPipe],
  providers: [IsCurrentUserPipe, BuildUrlPipe, NumberFormatBrPipe]
})
